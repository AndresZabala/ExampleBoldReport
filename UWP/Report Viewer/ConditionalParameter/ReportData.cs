...
namespace ConditionalParameter
{
    public class ReportData
    {
        ...
        {
            string[] prodcutName = new string[] { "Zabala, 42", "Mountain-100 Black, 44", "Mountain-100 Black, 48", "Mountain-100 Silver, 38", "Long-Sleeve Logo Jersey, M", "Mountain Bike Socks, M", "Long-Sleeve Logo Jersey, L", "Road-450 Red, 52" };
